...
import { Zap, Copy, Check, Loader2, Sparkles, Languages, Search, Hash } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto space-y-12 relative z-10 pt-8 px-4">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-5xl lg:text-7xl font-black text-white tracking-tighter uppercase italic leading-none">
            AI <span className="gold-gradient-text">UTILITIES</span>
          </h1>
          <p className="text-slate-500 max-w-xl mx-auto font-medium">
            Neural-powered tools to clean, verify, and insight global address data in real-time.
          </p>
        </div>
          ...
          >
            <div className="p-8 lg:p-10 space-y-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-black text-white uppercase italic leading-tight">Address Standardizer</h2>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[3px]">Normalize messy input</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 block italic">Paste Messy Address</label>
                  <textarea
                    value={address}
                ...
                >
                  {loading ? (
                    ...
                    <>
                      ...
                      <span className="uppercase text-xs tracking-[4px] font-black italic">Standardize Address</span>
                    </>
                  )}
                </button>
              </div>
            ...
            {result && (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[10px] font-black text-gold uppercase tracking-[3px] italic uppercase">Verified Output</span>
                  <button
          ...
          >
            <div className="p-8 lg:p-10 space-y-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-black text-white uppercase italic leading-tight">Locality Insights</h2>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[3px]">Area context analysis</p>
                </div>
              </div>

              <div className="space-y-6">
                <div>
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 block italic">Area Name or ZIP/PIN</label>
                  <input
                    type="text"
                    value={postalQuery}
                ...
                >
                  {insightLoading ? (
                    ...
                    <>
                      ...
                      <span className="uppercase text-xs tracking-[4px] font-black italic">Get AI Insight</span>
                    </>
                  )}
                </button>
              </div>
            ...
            {insight && (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-black text-gold uppercase tracking-[3px] italic">Locality Briefing</span>
                </div>
